...
Source0  : https://github.com/axel-download-accelerator/axel/releases/download/v2.17.10/axel-2.17.10.tar.xz
...
%prep
%setup -q -n axel-2.17.10
cd %{_builddir}/axel-2.17.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629756168
...
cp %{_builddir}/axel-2.17.10/COPYING %{buildroot}/usr/share/package-licenses/axel/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
%find_lang axel
